...
const CONTENT: Record<Status, { icon: ReactNode; text: string }> = {
  current: {
    icon: <Clock className="size-24 md:size-28 text-slate-300" />,
    text: "سفارشی در حال انجام ندارید.",
  },
  delivered: {
    icon: <PackageCheck className="size-24 md:size-28 text-slate-300" />,
    text: "سفارش تحویل‌شده‌ای وجود ندارد.",
  },
  returned: {
    icon: <Undo2 className="size-24 md:size-28 text-slate-300" />,
    text: "مورد مرجوع‌شده‌ای ندارید.",
  },
  canceled: {
    icon: <XCircle className="size-24 md:size-28 text-slate-300" />,
